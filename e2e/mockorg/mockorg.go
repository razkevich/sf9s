...
// apexLogRecords returns the record JSON and how many records it contains —
// counting "attributes" would also count each record's nested objects.
func (s *Server) apexLogRecords() (string, int) {
